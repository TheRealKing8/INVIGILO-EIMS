"""Reconcile the RBAC matrix after adding ``accounts.user.reset_password``.
...
codename when they upgrade. Same idempotent reconcile pattern as
0005/0006 — re-apply all roles, permissions, and role-permission
edges from ``apps.accounts.seed``.
"""
